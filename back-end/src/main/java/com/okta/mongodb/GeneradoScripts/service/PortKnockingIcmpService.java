...
@Service
public class PortKnockingIcmpService {
       private static final Logger logger = LoggerFactory.getLogger(PortKnockingIcmpService.class);

       public Map<String, String> create(PortKnockingIcmpBody body) {
          ...
          private String generateHtmlScript(PortKnockingIcmpBody body) {
    ...
    //                        + body.getRateLimit() + "\" local-address=\"" + body.getLocalServerIPAddress()
     ...
     //         html.append("<span class='font-black'>/ppp secret</span> <br>");
       ...
       private String generatePlainTextScript(PortKnockingIcmpBody body) {
