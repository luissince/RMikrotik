  ...
  return (
    <>
      ...
      <div className="mt-8 p-4 bg-gray-700 rounded">
        <h2 className="block text-sm font-semibold text-gray-300 mb-2">
          Script Generator Result
        </h2>

        <div
          className="w-full overflow-x-scroll p-2 rounded bg-gray-800 text-gray-400 focus:outline-none min-h-80"
